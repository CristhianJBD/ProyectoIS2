...
class UserCreateForm(UserCreationForm):
    ...
    general_perms_list = [(perm.codename, perm.name) for perm in lista_perms_general()]
    general_perms_list.extend(permisos_usuarios_grupos())
