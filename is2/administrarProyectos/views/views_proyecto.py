...
from administrarProyectos.forms import MiembrosEquipoFormset
from administrarProyectos.models import Proyecto
from administrarProyectos.models import MiembroEquipo
from administrarProyectos.views.views import GlobalPermissionRequiredMixin, ActiveProjectRequiredMixin
from administrarProyectos.views.views import CreateViewPermissionRequiredMixin
...
class ProjectList(LoginRequiredMixin, ListView):
    ...
    template_name = 'administrarProyecto/proyecto/project_list.html'
...
class ProjectCreate(LoginRequiredMixin, CreateViewPermissionRequiredMixin, generic.CreateView):
    ...
    """
    model = Proyecto
    permission_required = 'administrarProyectos.add_proyecto'
    form_class = modelform_factory(Proyecto,
                                   widgets={'inicio': SelectDateWidget, 'fin': SelectDateWidget},
                                   fields=('nombre', 'fechainicio', 'fechafin', 'duracion_sprint',
                                           'descripcion'),)
